class StudentGradeManagement:
        ...
        for student_data in self.list_content:
            if student_data[0] == self.name:
                ...
                if percentage < 33:
                    ...
                    print(
                        f"Total marks you earned: {marks_earned} and overall grade: F"
                    )
                    ...
                    print(
                        f"Total marks you earned: {marks_earned} out of {total_subjects*100} and overall grade: {grade}"
                    )
                return

        print(
            "We cannot generate a report for you as we do not have your name in the list. It seems you entered the wrong name. Try again."
        )
    ...
    def delete_marks(self):
        ...
        print(
            ...
            if any(student_data[0] == delete_name for student_data in self.list_content)
            else "Name not found"
        )
