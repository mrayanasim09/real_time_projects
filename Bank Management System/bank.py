...
class Bank:
    ...
    def new_bank_account(self, customer_name, phone_number):
        ...
        print(
            f"A new bank account creation is requested with the name {customer_name}. Please recheck your phone number {phone_number}. Your account ID is {account_id}. Do not share this ID with anyone."
        )
        confirmation = input("Confirm? (y/n): ")

        if "y" in confirmation.lower():
            print(
                "Thank you for your confirmation. Our team will contact you in a few days."
            )
            ...
            update_field = input(
                "Which information do you want to change (name/number): "
            )
            ...
            if "na" in update_field.lower():
                ...
                with open("accounts.txt", "a") as file:
                    file.write(
                        f"Name: {new_name}, Phone Number: {phone_number}, ID: {account_id}\n"
                    )
                ...
                with open("accounts.txt", "a") as file:
                    file.write(
                        f"Name: {customer_name}, Phone Number: {new_phone_number}, ID: {account_id}\n"
                    )
                    print("Stored your updated information.")
            ...
            with open("balance.txt", "w") as file:
                ...
                for line in lines:
                    if str(account_id) in line:
                        ...
                        file.write(
                            f"Name: {customer_name}, ID: {account_id}, Balance: {new_balance}\n"
                        )
                        account_found = True
                    else:
                        file.write(line)
                ...
                if not account_found:
                    file.write(
                        f"Name: {customer_name}, ID: {account_id}, Balance: {deposit_amount}\n"
                    )
        else:
        ...
        with open("balance.txt", "w") as file:
            ...
            for line in lines:
                if str(account_id) in line:
                    ...
                    if new_balance < 0:
                        print(
                            "Withdrawal amount exceeds balance. Transaction cancelled."
                        )
                        return
                    file.write(
                        f"Name: {customer_name}, ID: {account_id}, Balance: {new_balance}\n"
    ...
    def information(self, customer_name, account_id):
        ...
        for line in lines:
            if str(account_id) in line:
                ...
                print(
                    f"Account found - Name: {customer_name}, ID: {account_id}, Balance: {balance_info}"
                )
                account_found = True
